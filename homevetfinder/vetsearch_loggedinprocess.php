...
<?php 
    ?><br>
	<?php echo "About Me: " . $result->fetch_assoc()['Vet_Bio']   . '<br>';
    $result->data_seek($j);?>
</div>
...
?>
 <form action="ApptTable.php" method="post">
  <input type="hidden" name="VetID" value=<?php echo "$VetID"; ?> >
   <input type="submit" class="w3-button w3-green w3-hover-red" style="margin-bottom: 100px; margin-left: 17px;" value="Make Appointment"></form>
