...
if ($conn->query($query) === TRUE)
 {
 echo "Appointment: '$AppointmentID' has been deleted Dr.'$vetName'<br>";
  $query2="UPDATE Availability SET Occupied='No' WHERE Availability.VetID='$VetID' AND Availability.TimeID='$TimeID' AND Occupied='Yes'";
