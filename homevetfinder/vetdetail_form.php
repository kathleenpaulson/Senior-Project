...
<form class="w3-container" action="vetdetail_process.php" method="post"><pre>
First Name   <input class="w3-input w3-border" type="text" name="vetFirstName" required>
Last Name    <input class="w3-input w3-border" type="text" name="vetLastName" required>
Email        <input class="w3-input w3-border" type="email" name="Email" required>
Street       <input class="w3-input w3-border" type="text" name="VetStreet" >
...
Zip Code     <input class="w3-input w3-border" type="text" name="vetZipCode" required> 
Phone        <input class="w3-input w3-border" type="text" name="Phone_Number" required> 
Your Vet Bio:           
<textarea name="VetBio" rows="10" cols="40"></textarea>
