...
$confirm=$_POST['confirm'];
 ...
 $sql="UPDATE Invoices SET Paid='Paid' WHERE InvoiceID='$InvoiceID' AND VetID='$VetID' AND UserID='$UserID' AND CareID='$CareID' AND Paid='Pending'";
 if ($conn->query($sql) === TRUE) 
     {
    echo "You have approved payment from $userFirstName $userLastName<br>";
     } 
     else 
     {
