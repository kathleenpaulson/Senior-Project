...
<?php 
  ...
  echo "<!DOCTYPE html>\n<html><head><title>Create Account Form</title>";
...
echo <<<_END
	    ...
	    <body>
	    <div>
	        <p class="center"><IMG SRC="images/animated_dog.gif"></p>
	        <br><br>	        
	    </div>
	    <h3 class="center"><a href="clientdetail_form.php">Click here to complete your registration.</a></h3>
...
echo <<<_END
  ...
  <body>
  <h1>Welcome to Home Vet Finder!</h1>
...
echo <<<_END
      ...
      <form method="post" action="clientsignup.php" onSubmit="return validate(this)">
